            ...
            for j, value in enumerate(line):
                if value:
                    ...
                    if record_index == -1:
                        ...
                        if record_index == j-1:
                            # if record index is the a previous token index, then do not consider to merge the previous mask and continue
                            record_index = -1
                            continue
                        # start to merge: remove the one mask token (under record index) and convert the previous token into a mask token
